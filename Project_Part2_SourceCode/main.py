...
if __name__ == "__main__":
    ...
    if training_features is not None and test_features is not None:
        ...
        print(f"\nTask 3 completed! Processed {len(results)} test videos.")
...
def gesture_recognition(test_features, test_video_names, training_features, training_video_names, output_path):
    ...
    def extract_gesture_name(video_filename):
    ...
    for i, test_feature in enumerate(test_features):
        ...
        recognized_training_video = training_video_names[max_similarity_index]
        
        gesture_name = extract_gesture_name(recognized_training_video)
        test_gesture_name = extract_gesture_name(test_video_names[i])
        
        results.append([test_gesture_name, gesture_name])
